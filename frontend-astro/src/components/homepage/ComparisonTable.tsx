...
import { fetchAllIPOsForComparison, getLatestGmp, getLatestSubscription } from '../../lib/api';
...
export default function ComparisonTable({ category }: { category: string }) {
    ...
    const sortedIPOs = [...transformedIPOs].sort((a, b) => {
                        ...
                        {sortedIPOs.length > 0 ? (
                            sortedIPOs.map(ipo => (
                                <tr key={ipo.id}>
                                    ...
                                    <td>
                                        <a href={`/ipo/${ipo.slug}`} className={styles.viewButton}>
                                            View
                                        </a>
                                    </td>
                                </tr>
                            ...
                            <tr>
                                <td colSpan={10} className={styles.emptyRow}>
                                    No IPOs available for comparison
                                </td>
                            </tr>
                        )}
                    </tbody>
